...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .badge { display: inline-block; background: rgba(52,211,153,.15); color: #34d399; border: 1px solid rgba(52,211,153,.3); border-radius: 99px; padding: 4px 14px; font-size: .8rem; text-transform: uppercase; letter-spacing: .08em; margin-bottom: 20px; }
...
<body>
    <div class="card">
        <div class="badge">Fornecedor</div>
        <h1>Olá, {{ Auth::user()->name }}!</h1>
        <p>Você está logado como <strong>fornecedor</strong>.<br/>O dashboard completo está em construção.</p>
